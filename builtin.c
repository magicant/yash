...
static struct builtin_info {
	...
	/* builtin.c の組込みコマンド */
	{ ":",       { builtin_true,    BI_SPECIAL }},
	{ "true",    { builtin_true,    BI_SEMISPECIAL }},
	{ "false",   { builtin_false,   BI_SEMISPECIAL }},
	{ "cd",      { builtin_cd,      BI_SEMISPECIAL }},
	{ "pwd",     { builtin_pwd,     BI_SEMISPECIAL }},
	{ "type",    { builtin_type,    0 }},
	{ "umask",   { builtin_umask,   BI_SEMISPECIAL }},
	{ "history", { builtin_history, 0 }},
	{ "alias",   { builtin_alias,   BI_SEMISPECIAL }},
	{ "unalias", { builtin_unalias, BI_SEMISPECIAL }},
	{ "option",  { builtin_option,  0 }},
	{ "hash",    { builtin_hash,    0 }},
	{ "rehash",  { builtin_hash,    0 }},

	/* builtin_job.c の組込みコマンド */
	{ "exit",    { builtin_exit,    BI_SPECIAL }},
	{ "logout",  { builtin_exit,    0 }},
	{ "kill",    { builtin_kill,    BI_SEMISPECIAL }},
	{ "wait",    { builtin_wait,    BI_SEMISPECIAL }},
	{ "suspend", { builtin_suspend, 0 }},
	{ "jobs",    { builtin_jobs,    BI_SEMISPECIAL }},
	{ "disown",  { builtin_disown,  0 }},
	{ "fg",      { builtin_fg,      BI_SEMISPECIAL }},
	{ "bg",      { builtin_fg,      BI_SEMISPECIAL }},
	{ "exec",    { builtin_exec,    BI_SPECIAL }},
	{ ".",       { builtin_source,  BI_SPECIAL }},
	{ "source",  { builtin_source,  BI_SPECIAL }},
	{ "eval",    { builtin_eval,    BI_SPECIAL }},
