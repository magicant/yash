...
"long as it is smaller than or equal to the hard limit. You can decrease a\n"
"hard limit, but cannot increase it without a proper permission. <limit> must\n"
"be a non-negative integer,\"hard\", \"soft\" or \"unlimited\".\n"
